...
import classes from './kuruyaAyirmaFisi.scss';
...
class kuruyaAyirmaFisi extends Component {
    state = {
        data: null,
        receiptNumber: "",
    ...
    postSearchButton = async () => {
        ...
        await axios.put('/novifarm/GetKuruyaAyirma', postfisNo)
            .then(async response => {
        ...
        if (this.state.notFound) {
            ...
            await axios.put('/novifarm/GetKuruyaAyirma', postIrsaliyeNo)
            .then(async response => {
                //console.log(response);
                this.setState({
                    data: response.data,
    ...
    updateDataButton = async () => {
        ...
        await axios.put('/novifarm/UpdateKuruyaAyirma', post)
            .then(async res => {
                this.setState({
                    error: false,
    ...
    render() {
        ...
        return (
            <div className={classes.kuruyaAyirmaFisi}>
            {this.state.error && this.state.receiptNumber !== null 
                ...
                <div className={classes.kuruyaAyirmaFisi__section_about}>
                    <div className={classes.u_center_text}>
                        <h2 className={classes.heading_secondary}>
                            Novifarm Kuruya Ayırma Fişi
                        </h2>
                    </div>
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__0}>
                    <span>Fiş No Giriniz</span>
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__1}>
                    <ReceiptNoInputText
                ...
                <div className={classes.kuruyaAyirmaFisi__item__2}>
                    <SearchButton click={this.postSearchButton} />
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__3}>
                    <span>IntegrationState:</span>
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__4}>
                    <span>Integration:</span>
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__5}>
                    <span>Fiş No:</span>
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__6}>
                    <ReceiptNoInputText
                        disabled="true"
                        receiptNumberBlocked={this.state.receiptNumberBlocked} />
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__7}>
                    <ReceiptNoInputText
                        status={this.state.integrationState}
                        changed={this.integrationStateChancedHandler} />
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__8}>
                    <ReceiptNoInputText
                        status={this.state.integration}
                        changed={this.integrationChancedHandler} />
                </div>
                <div className={classes.kuruyaAyirmaFisi__item__9}>
...
export default kuruyaAyirmaFisi;