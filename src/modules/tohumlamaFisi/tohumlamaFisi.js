...
import classes from './tohumlamaFisi.scss';
...
class tohumlamaFisi extends Component {
    state = {
        data: null,
        receiptNumber: "",
    ...
    postSearchButton = async () => {
        ...
        await axios.put('/novifarm/GetTohumlamaKayitFisi', postfisNo)
            .then(async response => {
        ...
        if (this.state.notFound) {
            ...
            await axios.put('/novifarm/GetTohumlamaKayitFisi', postIrsaliyeNo)
            .then(async response => {
                //console.log(response);
                this.setState({
                    data: response.data,
    ...
    updateDataButton = async () => {
        ...
        await axios.put('/novifarm/UpdateTohumlamaKayitFisi', post)
            .then(async res => {
                this.setState({
                    error: false,
    ...
    render() {
        ...
        return (
            <div className={classes.tohumlamaFisi}>
            {this.state.error && this.state.receiptNumber !== null 
                ...
                <div className={classes.tohumlamaFisi__section_about}>
                    <div className={classes.u_center_text}>
                        <h2 className={classes.heading_secondary}>
                            Novifarm Tohumlama Fişi
                        </h2>
                    </div>
                </div>
                <div className={classes.tohumlamaFisi__item__0}>
                    <span>Fiş No Giriniz</span>
                </div>
                <div className={classes.tohumlamaFisi__item__1}>
                    <ReceiptNoInputText
                ...
                <div className={classes.tohumlamaFisi__item__2}>
                    <SearchButton click={this.postSearchButton} />
                </div>
                <div className={classes.tohumlamaFisi__item__4}>
                    <span>IntegrationState:</span>
                </div>
                {/* <div className={classes.tohumlamaFisi__item__4}>
                    <span>Integration:</span>
                </div> */}
                <div className={classes.tohumlamaFisi__item__3}>
                    <span>Fiş No:</span>
                </div>
                <div className={classes.tohumlamaFisi__item__7}>
                    <ReceiptNoInputText
                        disabled="true"
                        receiptNumberBlocked={this.state.receiptNumberBlocked} />
                </div>
                <div className={classes.tohumlamaFisi__item__8}>
                    <ReceiptNoInputText
                ...
                <div className={classes.tohumlamaFisi__item__9}>
